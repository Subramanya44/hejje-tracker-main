...
export class ComplaintsService {
  ...
  async insterComplaint (data: any, dataId?: number): Promise<any> {
    try {
  ...
  async getComplaintById(trackId: number): Promise<any> {
    try {
  ...
  async fetchAllComplaints(startDate?: string, endDate?: string): Promise<any> {
  ...
  async updateComplaintStatus(trackId: number, newStatus: string): Promise<any> {
    try {
      const {data: updatedData, error} = await this.supabase
        .from('tbl_complaints')
