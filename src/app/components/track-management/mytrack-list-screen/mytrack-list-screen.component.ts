...
@Component({
  selector: 'app-mytrack-list-screen',
  templateUrl: './mytrack-list-screen.component.html',
  styleUrls: ['./mytrack-list-screen.component.css'],
})
export class MyTrackListScreenComponent  implements OnInit {
  ...
  constructor(private trackService: TrackService,private modalController: ModalController) { }
